...
d = read.csv("C:\Users\姜惠元\Desktop\pythonProject\oversampling-techniques-master\sample.csv",header = TRUE)
...
while(i_k<k)
{
	...
	models[[n]] <- J48(as.factor(Class)~., D[(n-1)*step+ seq_along(D[, 1]),])
